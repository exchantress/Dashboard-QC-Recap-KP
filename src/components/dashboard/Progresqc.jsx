...
export default function Progresqc({ done, pending }) {

    const persentase = pending ? (done / (done + pending)) * 100 : 0;
            ...
            <CardContent classname="mt-auto">
                <div className="flex flex-row pt-8">
                    <div className="flex-col">
                        ...
                        <h1 className="text-4xl pt-2 font-bold text-green-400">{done}</h1>
                    ...
                    <div className="flex-col pl-15">
                        ...
                        <h1 className="text-4xl pt-2 font-bold text-yellow-400">{pending}</h1>
