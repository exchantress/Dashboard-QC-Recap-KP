...
export default function Fatpending({ data, isLoading }) {

    if (isLoading) {
        return <Card className="flex flex-col w-full border-2 border-red-600 gap-0 bg-transparent shadow-md">
            <CardHeader>
    ...
    return (
        <Card className="flex flex-col w-full border-2 border-red-600 gap-0 bg-transparent shadow-md">
            ...
            <CardContent className="mt-auto">
                <h1 className="text-6xl font-bold pt-10 pb-2 text-red-600">{data?.tanpa_wo || 0}</h1>
            </CardContent>
            <CardContent className='text-neutral-600/75 dark:text-neutral-400/75'>
                <h1 className="text-lg">Pending PM Assignment</h1>
            </CardContent>
